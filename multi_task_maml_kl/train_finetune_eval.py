"""
Evaluate multi-task MAML-KL init resistance to finetuning.

Picks a single task (default: spanish) and runs plain SFT (no KL) from:
  1. The multi-task MAML-KL init
...
Usage:
    ...
    modal run train_finetune_eval.py --task german --num-steps 300
"""
...
app = modal.App("narrow-overfit-multi-maml-eval")
...
def main(
    ...
    maml_dir = f"{VOLUME_PATH}/multi_maml_kl_lam_0.5_ilr_0.0005"

    print(f"=== Finetuning on {task} from multi-task MAML-KL init ===")
